        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-3 item">
                    ...
                    <ul>
                        <!--<li><a href="#">Tel : </a></li>-->
                        <li><a href="mailto:admin@doacc.rf.gd">Email : admin@alertMyWishlist.rf.gd</a></li>
                        <li><a href="<?php echo $linkPrefix; ?>index.php">Web : www.alertMyWishlist.rf.gd</a></li>
                    </ul>
                </div>
                <div class="col-sm-6 col-md-3 item">
                    <h3>Mobile App</h3>
            ...
            <p class="copyright">AlertMyWishlist © 2022</p>
        </div>
    </footer>
<?php } ?>