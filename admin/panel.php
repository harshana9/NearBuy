...
<body>
    <nav class="navbar navbar-light navbar-expand-lg bg-light navigation-clean">
        <div class="container"><a class="navbar-brand" href="#">NearBuy Admin</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link active" href="../index.php">Visit Main App</a></li>
            ...
            <div class="row">
                <div>
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item" role="presentation"><a class="nav-link <?php echo $activitylinkclass; ?>" role="tab" data-bs-toggle="tab" href="#myactivity" id="myactivity_link">Posts for Review</a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link <?php echo $profilelinkclass; ?>" role="tab" data-bs-toggle="tab" href="#mywishlist" id="profile_link">Verify Payments</a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link <?php echo $profilelinkclass; ?>" role="tab" data-bs-toggle="tab" href="#addtowishlist" id="profile_link">Authenticate Users</a></li>
